...
PROGRAM test
        ...
        REAL :: emitA(4,long_detail*short_detail), emitB(4,long_detail*short_detail), meas(3,meas_detail**2), r(meas_detail**2)
        !COMPLEX :: tm(meas_detail**2, long_detail*short_detail), p(long_detail*short_detail) = 1, cr(meas_detail**2)
        COMPLEX :: p(long_detail*short_detail) = 1, cr(meas_detail**2) = 0
        INTEGER :: pc, col
        ...
        center = (/ 0.0, 0.0, 0.0 /)
        aside = (/ 0.002, 0.002, 0.0 /)
        !bside = (/ 0.0, 0.0, 0.0 /)
        CALL gen_line(center, aside, meas_detail**2, meas)
